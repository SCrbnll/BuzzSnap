  ...
  <Modal.Body style={{ maxHeight: "70vh", overflowY: "auto" }}>
    ...
    <div className="d-flex flex-column flex-md-row align-items-center gap-3">
      <div className="position-relative text-center">
        ...
        >
          <i className="bi bi-camera-fill text-white" style={{ fontSize: "16px" }}></i>
          <input
            id="avatarUpload"
            type="file"
            accept="image/*"
    ...
    <div className="d-flex flex-wrap gap-3">
      {onChangeEmail && (
        <Button className="button-modal w-100 w-md-auto" onClick={onChangeEmail}>
          <i className="bi bi-envelope"></i> Cambiar Email
        </Button>
      )}
      {onChangePassword && (
        <Button className="button-modal w-100 w-md-auto" onClick={onChangePassword}>
